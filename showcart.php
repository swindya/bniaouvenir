...
function confirmcart()
{
	...
	document.forms["confirmcart"].submit();
}
</script>
...
?>
	...
	<tr height="30px">
		...
		<td style="padding-left: 0px; padding-top: auto; text-align: center;" width="70px">
			<img id="img_01" src="DOC/IMAGES/thumb/image2.jpg" height="70" width="70"/>
		</td>
		...
		<td style="padding-left: 0px; padding-top: auto; text-align: center; vertical-align: top" width="100px">
			<input style="text-align: center; font-size: 1.0em; font-famili: Roboto" type="text" class="textboxnarrow" id="qty" name="qty" value="<?php echo number_format($qtyku[$a],0);?>">
		</td>
...
?>
	...
	<tr height="20px">
		<td colspan="7" style="padding-left: 0px; padding-top: auto; text-align: right;">
			<FONT style="text-align: right; font-size: 1.6em; font-famili: Arial; color: #777777">Total:</FONT>
	...
	<tr height="20px">
		<td colspan="7" style="padding-left: 0px; padding-top: auto; text-align: right;">
			<button type="button" class="btn btn-success btn-lg" onmouseover="cekme();" onclick="confirmcart();">Confirm</button>
		</td>
	</tr>
</table>
