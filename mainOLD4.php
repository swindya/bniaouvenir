...
if ($row_cnt>0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		$image1ku[$i] = $imagepathku[$i] . $imagename1ku[$i];
		$image2ku[$i] = $imagepathku[$i] . $imagename2ku[$i];
		$image3ku[$i] = $imagepathku[$i] . $imagename3ku[$i];
	}
}
$jmldata = $i;
...
<div align="center">
<table class="center" style="margin-top: 80px;" width="900px" border="0" cellspacing="0" cellpadding="0">
	<!--tr height="20px">
	...
	<tr>
		<td style="padding-left: auto;text-align: right; font-size: 1.1em; font-family: Assistant">
			<div style="font-size: 1.1em; font-family: Assistant" class="container">  
					<select class="selectpicker" id="mysort" name="mysort" onchange="viewshopme(<?php echo $userid;?>,<?php echo $levelidku;?>,'urut');">
							...
							<div class="item active">
								<div class="row">
									<div class="col-sm-4">
										<div class="col-item">
											<div class="photo">
												<img src="<?php echo $image1ku[$jmldata];?>" onclick="viewproduct(<?php echo $idku[$jmldata];?>);" width="200px" height="200px" alt="a"></a>
											</div>
											<div class="info">
												<div class="row">
												...
												<div class="separator clear-left">
													...
													<p class="btn-details">
														<i class="fa fa-list"></i><a href="#" class="hidden-sm" onclick="viewproduct(<?php echo $idku[$jmldata];?>);">Details</a></p>
												</div>
												<div class="clearfix">
												</div>
											</div>
									...
									<div class="col-sm-4">
										<div class="col-item">
											<div class="photo">
												<img src="<?php echo $image1ku[$jmldata-1];?>" onclick="viewproduct(<?php echo $idku[$jmldata-1];?>);" width="200px" height="200px" alt="a"></a>
											</div>
											<div class="info">
												<div class="row">
													<div class="price col-md-8">
									...
									<div class="col-sm-4">
										<div class="col-item">
											<div class="photo">
												<img src="<?php echo $image1ku[$jmldata-2];?>" onclick="viewproduct(<?php echo $idku[$jmldata-2];?>);" width="200px" height="200px" alt="a"></a>
											</div>
											<div class="info">
												<div class="row">
	...
	<tr valign="middle" height="40px">
		<td style="padding-left: auto;text-align: right; font-size: 1.1em; font-family: Assistant">
			<div class="container">                                        
				<a href="#" class="hidden-sm"><b>See more</b></a>
			</div>
		</td>
	</tr>
</table>
