...
<script>
function updateqty(userid, cartid, qtyold, qty)
{
	//var r = confirm('Delete item in cart ?');
	//if (r) {
		if (window.XMLHttpRequest) {
		...
		xmlhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				var staa = this.responseText.trim();
				if (staa==1 || staa=="1")
				{
		...
		var strku = "updateqtycart.php?userid="+userid+"&cartid="+cartid+"&qty="+qty+"&qtyold="+qtyold;
//alert(strku);
		xmlhttp.open("GET",strku,true);
		xmlhttp.send();
	//}
...
if ($userid==0)
{
	if (!isset($_POST["useridvc"])) {
		$userid=0;
	}
	else
		$userid=$_POST["useridvc"];
}
if ($userid==0)
{
	if (!isset($_SESSION["userid"])) {
...
$tglsaiki = date('Y-m-d');
//---------------------------------------------------------------------------------------------------
$query = "SELECT * FROM cart WHERE productID=" . $prodid . ";";
//echo "<br><br><br>---------------------" . $query . "<br>";
...
if ($row_cnt>0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		if ($imagename1ku[$i]=="" || $imagename1ku[$i]==null || strlen($imagename1ku[$i])<4)
			$imagename1ku[$i] = "no-image.jpg";
...
<form name="myconfirm" id="myconfirm" action="confirmcart.php" method="post" enctype="multipart/form-data">
	<input type="hidden" id="userid" name="userid" value="<?php echo $userid;?>">
	<!--input type="hidden" id="userid" name="userid" value="<?php echo $userid;?>"-->
</form>

<table style="text-align: center; margin-left: auto; margin-right: auto; margin-top: auto;" width="920px" border="0" cellspacing="0" cellpadding="0">
		<tr height="150px">
...
<table style="text-align: center; margin-left: auto; margin-right: auto; margin-top: auto;" width="1050px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		...
		<td colspan="2" style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 1.0em" width="650px">
...
?>
	...
	<tr height="30px">
		...
		<td style="padding-left: 0px; padding-top: auto; text-align: center;" width="70px">
			<img id="img_01" src="<?php echo $image1ku[$a];?>" height="70" width="70"/>
		</td>
		<td style="padding-left: 15px; padding-top: auto; text-align: left; vertical-align: top" width="580px">
		...
		<td style="padding-left: 0px; padding-top: auto; text-align: center; vertical-align: top">
			<input style="text-align: center; font-size: 1.0em; font-famili: Roboto" type="text" class="textboxnarrow" id="qty" name="qty" value="<?php echo number_format($qtyku[$a],0);?>" onchange="updateqty(<?php echo $userid;?>,<?php echo $IDku[$a];?>,<?php echo $qtyku[$a];?>,this.value)">
			<input id="qtyold<?php echo $a;?>" name="qtyold<?php echo $a;?>" value="<?php echo $qtyku[$a];?>" type="hidden">
		</td>
		<td style="padding-left: auto; padding-top: auto; margin-right: auto; text-align: right; vertical-align: top">
			<?php echo "Rp. " . number_format($unitpriceku[$a],0);?>
		</td>
		<td style="padding-left: 0px; padding-top: auto; padding-right: auto; text-align: right; vertical-align: top">
			<?php $subtot=$qtyku[$a] * $unitpriceku[$a]; $total=$total+$subtot; echo "Rp. " . number_format($subtot,0);?>
		</td>
		<td style="padding-left: 0px; padding-top: auto; margin-right: 20px; text-align: right; vertical-align: top">
...
?>
	...
	<tr height="20px">
		<td colspan="7" style="padding-left: 0px; padding-top: auto; text-align: right;">
			<button type="button" class="btn btn-success btn-lg" onmouseover="cekme();" onclick="confirmcart(<?php echo $userid;?>);">Confirm</button>
		</td>
	</tr>
</table>
...
<table style="text-align: center; margin-left: auto; margin-right: auto; margin-top: auto;" width="920px" border="0" cellspacing="0" cellpadding="0">
		<tr height="100px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 1.8em">
			</td>
		</tr>
		<tr height="50px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 2.2em">
				<b><font color="red">
				<img src="./images/cart-empty.png" width="400px" height="300px" alt="a"></a>
				</font></b>
			</td>
		</tr>
		<tr height="30px">
		...
		<tr height="50px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 1.6em">
				<font color="green">
					<a href='#' onclick="viewshopping(<?php echo $userid;?>,<?php echo $levelidku;?>,'sortaz');">
