...
?>
	...
	<div align="center">
	<table class="center" style="margin-top: 30px;" width="840px" border="0" cellspacing="0" cellpadding="0">
		<!--tr height="20px">
		...
		<tr height="50px">
			<td style="padding-left: auto; text-align: center; font-size: 2.0em; font-family: Assistant" width="230px">
			</td>
			<td style="padding-left: auto; text-align: center; font-size: 2.0em; font-family: Assistant" width="640px">
				<div class="w3-content w3-display-container">
<?php
				if (strlen($bannerfile1y)>3)
				{
?>
					<img class="mySlides" src="<?php echo $imagefile1y;?>">
<?php
				}
				if (strlen($bannerfile2y)>3)
				{
?>
					<img class="mySlides" src="<?php echo $imagefile2y;?>">
<?php
				}
				if (strlen($bannerfile3y)>3)
				{
?>
					<img class="mySlides" src="<?php echo $imagefile3y;?>">
<?php
				}
?>
	...
	<table class="center" style="margin-top: 30px;" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr height="20px">
			<td style="padding-left: 200px;text-align: left; font-size: 2.0em; font-family: Assistant">
