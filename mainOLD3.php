...
<script>
function carouselcombo(a)
{
	document.getElementsByName("sortharga")[0].value = a;
...
{
?>
<meta http-equiv="refresh" content="10; url=index.php?err=1002" />
<?php
...
if ($row_cnt>0) {
	...
	while ($row = mysqli_fetch_array ($result, MYSQLI_ASSOC)) {
		...
		$imagenameku[$i] = $row['imagename'];
		$imagepathku[$i] = $row['imagepath'];
		$imageku[$i] = $imagepathku[$i] . $imagenameku[$i];
	}
}
$jmldata = $i;
...
<table style="text-align: center; margin-left: auto; margin-right: auto; margin-top: 35px;" width="900px" border="0" cellspacing="0" cellpadding="0">
		...
		<tr height="20px">
			<td style="padding-left: 0px; padding-top: 70px; text-align: center;  font-size: 2.8em; width: 900px">
				<b><font face="Ubuntu" color="#555555">WELCOME</font></b>
			</td>
		</tr>
		<tr height="0px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; width: 900px">
		...
		<tr height="20px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 2.8em">
				<font face="Ubuntu" color="#555555"><b>TO</b></font>
			</td>
		</tr>
		<tr height="0px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; width: 900px">
		...
		<tr height="20px">
			<td style="padding-left: 0px; padding-top: auto; text-align: center; font-size: 2.8em">
				<font face="Ubuntu" color="#555555"><b>BNISOUVENIR.COM</b></font>
			</td>
		</tr>
</table>
...
<!--div align="center">
<table class="center" style="margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
	<!-tr height="20px">
		<td style="padding-left: 9%;text-align: left; font-size: 2.0em; font-family: Assistant">
			<b>Produk Baru</b>
		</td>
	</tr->
	<tr>
...
<form method="post" name="mymain" id="mymain" action="" enctype="multipart/form-data">
...
<table class="center2" style="padding-top: auto;" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td style="padding-left: auto;text-align: right; font-size: 1.1em; font-family: Assistant">
			<div class="container">                                        
			  <div class="dropdown">
				<button style="font-size: 1.0em; font-family: Assistant" class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Urutkan
				<span class="caret"></span></button>
				<ul style="font-size: 1.0em; font-family: Assistant" class="dropdown-menu" role="menu" aria-labelledby="menu1">
				  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="carouselcombo('murah');">Harga Termurah</a></li>
				  <li role="presentation"><a role="menuitem" tabindex="-1" href="#" onclick="carouselcombo('mahal');">Harga Tertinggi</a></li>
				</ul>
			  </div>
			</div>
		</td>
...
<table class="center2" style="padding-top: 0;" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td style="padding-left: auto;text-align: right; font-size: 1.0em; font-family: Assistant">
			<section class="section-white visible-md visible-lg ">
				<div class="container ">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<a href="#" onclick="viewproduct(<?php echo $idku[$jmldata];?>)"><img src="<?php echo $imageku[$jmldata];?>" width="200px" height="50px" alt="Internet Services"></a>
								<div class="carousel-caption">
									<table style="padding-top: 0;" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="font-size: 1.6em">
												<?php echo $nameku[$jmldata];?>
											</td>
										</tr>
										<tr>
											<td style="font-size: 1.1em">
												<font color="#FFE02D"><?php echo "Rp. " . "&nbsp;" . number_format($priceku[$jmldata],0);?></font>
											</td>
										</tr>
									</table>
								</div>
							...
							<div class="item">
								<a href="#" onclick="viewproduct(<?php echo $idku[$jmldata-1];?>)"><img src="<?php echo $imageku[$jmldata-1];?>" href="http://detik.com" alt="Internet Services"></a>
								<div class="carousel-caption">
									<table style="padding-top: 0;" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="font-size: 1.6em">
												<?php echo $nameku[$jmldata-1];?>
											</td>
										</tr>
										<tr>
											<td style="font-size: 1.1em">
												<font color="#FFE02D"><?php echo "Rp. " . "&nbsp;" . number_format($priceku[$jmldata-1],0);?></font>
											</td>
										</tr>
									</table>
								</div>
							...
							<div class="item">
								<a href="#" onclick="viewproduct(<?php echo $idku[$jmldata-2];?>)"><img src="<?php echo $imageku[$jmldata-2];?>" href="http://google.com" alt="Internet Services"></a>
								<div class="carousel-caption">
									<table style="padding-top: 0;" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="font-size: 1.6em">
												<?php echo $nameku[$jmldata-2];?>
											</td>
										</tr>
										<tr>
											<td style="font-size: 1.1em">
												<font color="#FFE02D"><?php echo "Rp. " . "&nbsp;" . number_format($priceku[$jmldata-2],0);?></font>
											</td>
										</tr>
									</table>
								</div>
