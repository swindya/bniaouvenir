...
{
	document.forms["myorderlist"].submit();
}
</script>
...
{
	document.forms["myviewprofile"].submit();
}
</script>
...
//------------------------------------------------------------------------------------------
//Berapa banyak item/produk di cart
//------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------
...
//echo "<br><br><br><br>-----------------" . $jmldatacart . "---" . $query . "<br>";

?>
<!--img src="./images/logobnismallok.png" 
   style="position:fixed; left:50px; top:20px; width:150px; height:50px; border:none;"
   ...
   title="Willmaster logo in fixed position" /-->
	...
	<div class="navbar">
	<a class="brand" href="#"><img src="./images/logobnismallok.png"  width="140" height="40"/></a>
	<!--MOBILE-->
	...
	<div class="navbar-inner visible-desktop">
		<ul class="nav">
			...
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="vieworderlist();"><i class="icon-folder-open" style="color: #007A71; font-size: 1.4em"> </i><font color="#333" size="2">Order</font> </a>
			</li>
<?php
		if ($levelidku>2)
		{
?>
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="viewcart();"><i class="icon-shopping-cart" style="color: #007A71; font-size: 1.4em"></i>  &nbsp;
				<font color="red" size="2" face="Roboto"><b><?php if ($jmldatacart>0) echo $jmldatacart;?></b></font></a>
			</li>
<?php
		}
?>
	...
	<form name="myviewcart" id="myviewcart" action="viewcart.php" method="post" enctype="multipart/form-data">
		<input type="hidden" id="useridvc" name="useridvc" value="<?php echo $userid;?>">
	</form>
	
	<form name="myorderlist" id="myorderlist" action="orderlist.php" method="post" enctype="multipart/form-data">
		<input type="hidden" id="useridc" name="useridc" value="<?php echo $userid;?>">
		<input type="hidden" id="statusvieww" name="statusvieww" value="0">
	</form>
	
	<form name="myviewprofile" id="myviewprofile" action="myaccount.php" method="post" enctype="multipart/form-data">
		<input type="hidden" id="useridacc" name="useridacc" value="<?php echo $userid;?>">
	</form>	
