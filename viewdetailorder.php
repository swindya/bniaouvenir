...
<?php
include "menu1.php";
include "menu2order.php";
?>

<form name="myupdatestatusorder" id="myupdatestatusorder" action="updatestatusorder.php" method="post" enctype="multipart/form-data">
	<input type="hidden" id="userid" name="userid" value="<?php echo $userid;?>">
	<input type="hidden" id="statusorderid" name="statusorderid">
...
<form name="myprintorder" id="myprintorder" action="printorder.php" method="post" target="_blank" enctype="multipart/form-data">
	...
	<input type="hidden" id="orderidprint" name="orderidprint" value="<?php echo $orderid;?>">
</form>


<table align="left" style="text-align: left; margin-left: 150px; margin-right: auto; margin-top: 150px;" width="1150px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="30px">
		<td colspan="3" style="padding-left: 0px; padding-top: auto; text-align: left;">
			<a href="#" onClick="printorder();"><button class="btn"><i class="fa fa-print"></i> &nbsp; Print Order</button></a>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="3" style="padding-left: 0px; padding-top: auto; text-align: center;">
...
?>
			<FONT face="arial" color="black">
				<input class="textbox" id="shippingcost" name="shippingcost" style="text-align: right; background-color: #99EFFF; font-size: 1.0em" onkeyup="formatnumber(this);" value="<?php if ($shipcostxu) echo number_format($shipcostxu,0);?>">
			</FONT>
<?php
			}
?>
...
?>
			<FONT face="arial" color="blue">
				<select style=" font-size: 1.0em" id="soflow" name="statusorder" onchange="showsatuan(this.value)">
  <!-- This method is nice because it doesn't require extra div tags, but it also doesn't retain the style across all browsers. -->
<?php
		for ($a=1; $a<=$jmlstatusorder; $a++)
		{
?>
					<option value="<?php echo $statusorderidx[$a];?>" <?php if ($soidxu==$statusorderidx[$a]) echo "selected";?>><?php echo $statusorderx[$a];?></option>
<?php
		}
?>
				</select>
...
<?php
			...
			{
?>
			<a class="medium button blue" onClick="updatestatusorder();"> &nbsp;&nbsp;&nbsp;UPDATE&nbsp;&nbsp;&nbsp; </a>
<?php
			}
?>
		</td>
	...
	<tr height="24px">
		...
		<td style="padding-left: 10px; padding-right: 20px; padding-top: auto; text-align: left; vertical-align: top; font-size: 1.1em;">
			<FONT face="Roboto" color="black">
				<?php if ($docxu) $mydoc=$docxu; else echo $mydoc="-";?>
<?php
				if ($docxu)
					$mydoc=$docxu; 
				else 
...
?>
				<a href="<?php echo $filenamebaru;?>" target="_blank"><font size="3" color="blue"><?php echo $mydoc;?></font></a>
			</font>
		</td>
		<td style="padding-left: 10px; padding-right: 20px; padding-top: auto; text-align: left; vertical-align: top; font-size: 1.1em;">
		</td>
	...
	<tr height="24px">
		...
		<td style="padding-left: 10px; padding-right: 20px; padding-top: auto; text-align: left; vertical-align: top; font-size: 1.1em;">
			<FONT face="Roboto" color="black">
				<form name="myuploaddoc" id="myuploaddoc" action="uploaddoc.php" method="post" enctype="multipart/form-data">
					<input type="hidden" id="useriddoc" name="useriddoc" value="<?php echo $userid;?>">
					<input type="hidden" id="orderiddoc" name="orderiddoc" value="<?php echo $orderid;?>">
					<input type="hidden" id="noorderdoc" name="noorderdoc" value="<?php echo $noorderxu;?>">
					<input name="myfile" id="myfile" type="file" onchange="PreviewImage(2);" />
				</form>
			</FONT>
		</td>
		<td style="padding-left: 10px; padding-right: 20px; padding-top: auto; text-align: left; vertical-align: top; font-size: 1.1em;">
...
<?php
			...
			{
?>
				<a class="button orange medium" OnClick="cekdataedit();">Upload</a>
<?php
			}
?>
		</td>
